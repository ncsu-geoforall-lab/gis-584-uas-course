...
- [Lake Wheeler data set (formatted as GRASS location): Lake_Wheeler_NCspm](https://drive.google.com/open?id=0B1AfQGDB8tPXNXVpOEdyejlpbEE) (you should already have it from previous assignments)
- 2013 lidar point cloud for Midpines
  - [Classified point cloud in LAS format: mid_pines_spm_2013.las](https://fatra.cnr.ncsu.edu/uav-lidar-analytics-course/mid_pines_spm_2013.las)
  - [All returns and classes in TXT format](https://fatra.cnr.ncsu.edu/uav-lidar-analytics-course/midpines_2013_spm_all.txt)
  - [Ground only in TXT format](https://fatra.cnr.ncsu.edu/uav-lidar-analytics-course/midpines_2013_spm_ground.txt)
  - [First return only in TXT format](https://fatra.cnr.ncsu.edu/uav-lidar-analytics-course/midpines_2013_spm_first.txt)
- 2015 UAS sample point cloud for Midpines sub-area, derived by SfM
  - [Sample point cloud: 2015_06_sample_points_NCsmp.las](https://drive.google.com/open?id=1ljf71bbOmghQEKHw392V-AHC0XcvzJNT)
...
In the assignment we will be using GRASS GIS 7.2.2 or higher, libLAS (included in GRASS GIS
...
First, download the <a href="https://drive.google.com/file/d/1Ke6Z--OcOBKOUJuUXcW7XowuGrewljTz/view?usp=sharing">GCP_12_decimal pack file</a> 
