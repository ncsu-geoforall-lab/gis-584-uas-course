...
In order to detect the bowl effect, an additional DSM needs to be computed. This time GCPs should not be used in the processing. You can repeat all the steps in Agisoft from the [Imagery processing assignment](../assignments/geoprocessing.html).
...
- [One generated in processing with 3 GCPs](https://drive.google.com/open?id=1RnYuH8_dhRyjfQ4rmqvnSO6uz-EuXqam) in the [Imagery processing assignment](../assignments/geoprocessing.html)
...
- [Nov 2015](https://drive.google.com/open?id=1HikUJ9XlJaFlwOmMCatYlQK_Pg37KVuN)
- [March 2017](https://drive.google.com/open?id=1xa7mTNGvPu2y4hPbqC2PhGZJ3AmzeDsR)
- [June 2016](https://drive.google.com/open?id=1Y9OuQLFyuA7n4oO5z9YJo0jPKiwoS-um)
