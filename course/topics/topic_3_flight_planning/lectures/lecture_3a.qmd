...
<section class="smaller">
<h3>Site evaluation and checklists</h3>
<p>Preflight inspection is required under Part 107.49; <br>the Remote Pilot in  Comand (RPIC) is required to develop a <strong>preflight inspection checklist</strong> if the manufacture has not developed one.</p>
::: {.columns}
::: {.column width="50%"}
<p class="small fragment"><a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=5&cad=rja&uact=8&ved=0ahUKEwi5oMOcj_7YAhWN71MKHaugClAQFghAMAQ&url=https%3A%2F%2Fconnect.ncdot.gov%2Fresources%2FAviation%2520Resources%2520Documents%2FNCDOT_Operational_Procedures_Template.docx&usg=AOvVaw0kdoCv8PlKVsnEPkF3rkoQ">NCDOT UAS Operational Procedures Guide</a>
<ul>
    <li class="small fragment">The checklist is usually integrated into the UAS flight software or can be obtained from the UAS vendor</li> 
    <li class="small fragment">In case that is not available, a standard Flight Checklist should be made and followed by the flight crew</li> 
</ul>
:::
::: {.column width="50%"}
<img src="../images/checklistNC.webp">
:::
:::
</section>
...
<section>
<h2>Flight planning software</h2>
<ul>
    <li class="fragment">Multiple available platforms</li> 
    <li class="fragment">Some are dedicated for specific UAS and sold with the system by the manufacturer</li> 
    <ul class="fragment">
        <li class="small"><a href="https://www.trimble.com/survey/unmanned-aircraft-systems">Trimble UAS<a> - <a href="https://apps.trimbleaccess.com/help/en/AerialImaging=2.2.6">Trimble Aerial Imaging</a>
        <li class="small"><a href="https://sensefly.com/">senseFly UAS<a> - <a href="https://sensefly.com/software/emotion/">eMotion 3</a>
        <li class="small"><a href="https://www.dji.com/">DJI<a> - <a href="https://www.dji.com/ground-station-pro">DJI Ground Station Pro</a>
        <li class="small"><a href="https://us.yuneec.com/">Yuneec<a> - <a href=”https://uavtoolbox.com/”>UAV Toolbox</a>
    </ul>
    <li class="fragment">Some are more universal and can work with variety of platforms:
<ul class="fragment">
    <li><a href="https://www.ugcs.com/">UgCS</a>
    <li>Open Source <a href=”https://ardupilot.org/planner/docs/mission-planner-overview.html”>Mission Planner</a> - mostly for DIY drones</li>
</ul>
</section>
