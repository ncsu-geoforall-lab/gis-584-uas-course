...
title: "Assignment 3A"
date: 9/14/2026
assignment-due-date: 9/30/2026
activity: Lab
notebook-view:
  - notebook: flight_plan_analysis.ipynb
    title: "Terrain Analysis of the flight site using GIS tools"
    url: https://colab.research.google.com/github/ncsu-geoforall-lab/gis-584-uas-course/blob/gh-pages/course/topics/topic_3_flight_planning/assignments/flight_plan_analysis.ipynb
resources:
  - flight_plan_analysis.ipynb
---
...
For this analysis you can run GRASS with the Lake_Wheeler_NCspm location. Create a new mapset to manage your flight analysis. 
