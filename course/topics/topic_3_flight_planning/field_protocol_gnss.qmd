...
- Lay the four GCPs on the pre-chosen spots, one toward each corner, none on the very edge. Weight them down. A surveyed GCP does not move.
...
- Photograph each GCP with the pole tip visible and log its number.
...
- Method B, the base log, and the four GCPs are finished before 11:00. That is why they come first.
...
- Four GCP spots chosen in advance
