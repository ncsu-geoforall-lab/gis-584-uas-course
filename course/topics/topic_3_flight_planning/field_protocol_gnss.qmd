...
Read this before the {{< var course_params.term >}} Lake Wheeler field flight. The site is available from 10:15 to 11:30. The class surveys the ground control targets together with the Emlid Reach RS4 rover, then flies the block with a DJI Mavic Air 2. The coordinates feed the Topic 3B lab.
...
2. The instructor gives an overview: what is being flown, why the targets and checkpoints exist, and where not to stand during the flight.
