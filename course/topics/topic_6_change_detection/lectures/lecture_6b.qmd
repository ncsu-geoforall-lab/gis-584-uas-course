...
format:
  revealjs:
    ...
    height: 800
    chalkboard: true
    footer: "[Return Home](../part_b_change_detection.qmd)"
execute:
  echo: false
---
...
:::
::: {.column width=50%}
![Jockey's Ridge, NC -  2024 4m](../images/remotesensing-14-01718-ag.png)
:::
...
## Data Pre-Processing { .text-center }
...
###  Jockey's Ridge { .text-center }
#### 1932 - 2009 { .text-center }
::: {.grid}
![1932](../images/airphoto_1932.png)
![1945](../images/airphoto_1945.png)
![1988](../images/airphoto_1955.png)
![1962](../images/airphoto_1962.png)
![1974](../images/airphoto_1974.png)
![1988](../images/airphoto_1988.png)
![2007](../images/airphoto_2007.png)
![2009](../images/airphoto_2009.png)
:::
...
> Addidional Resources (@sampath_guidelines_2023)
...
- **GCP-based correction** (preferred for absolute accuracy) (@mitasova_raster-based_2009)
- **Feature-based registration** (SIFT/SURF for automated tie points) (@sedaghat_high-resolution_2019)
- **ICP alignment** for DEMs and point clouds (@segal_generalized-icp_2009)
- **Nuth-Kääb Method** for DEMs (@nuth_co-registration_2011)
...
## Pre-Classification Change Detection { .text-center }
...
## Feature-Based & Object-Based Change Detection (OBIA) { .text-centered }
...
:::
::: {.column width=50%}
![@white_rapid-dem_2022](../images/remotesensing-14-01718-thematic.png)
:::
...
## Post-Classification Change Detection {.text-center}
