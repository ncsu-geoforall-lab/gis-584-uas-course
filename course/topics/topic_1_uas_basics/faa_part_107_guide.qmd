...
* **Recommended study resources**:  
  ...
  * Online courses from drone training providers like [Drone Pilot Ground School](https://www.dronepilotgroundschool.com/), [Pilot Institute](https://pilotinstitute.com/), [Gold Seal](https://groundschool.com/), etc.
...
* Your aeronautical knowledge recency is valid for **24 calendar months** (the certificate itself does not expire).
* To keep flying commercially, complete the FAA's free [online recurrent training](https://www.faa.gov/uas/commercial_operators/become_a_drone_pilot#keepCurrent) every two years (effective April 2021; there is no longer a paid recurrent test).
