...
- Do not intentionally fly over unprotected persons or moving vehicles, and remain **at least 25 feet away** from individuals and vulnerable property.
    * No longer need a waiver (as long as specific requirements are met).
::: {.column width="40%"}
...
**Example UAS**
- DJI Neo / DJI Mavic Mini / Mini 2 / Mini 3 Pro
...
::: {.columns}
::: {.column width="50%"}
- [U.S. Air Space map](https://nasstatus.faa.gov/map)
- [Know Before you Fly website](https://knowbeforeyoufly.org)
