...
| -------------- | ---------------- | ------ | ------------------------ |
| **ω (omega)**  | Roll             | x (flight direction) | Wing tilt side-to-side |
| **φ (phi)**    | Pitch            | y | Nose tilt forward/back |
...
- Log contains information about the location of the camera, not the location of the depicted object - [more info in lecture 2A](lecture_2a.qmd)
...
- For more information about placing targets and importance of GCPs see [lecture 2A](lecture_2a.qmd)
- For more information about processing the data with GCPs see [intro to the assignment](../assignments/assignment_2b.qmd)
...
::: notes
Filtering prunes outliers. Aggressive is the usual choice for aerial mapping and is what Assignment 2B uses; Mild preserves fine structure on complex objects with small foreground details; Moderate sits between. Choose based on scene complexity.
:::
...
- More on GCP placing and processing in Agisoft see [intro to the assignment](../assignments/assignment_2b.qmd)
