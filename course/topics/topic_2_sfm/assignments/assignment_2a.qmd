...
- [WebODM](https://webodm.org/) {{< var software.webodm.version >}}: free and open source, the software used for drone mapping. Native installers for Windows and macOS, Docker on Linux; 8 GB RAM minimum. It processes aerial and ground images, nadir or oblique, so it works for this assignment too, though its defaults are tuned for mapping flights rather than small objects. 
