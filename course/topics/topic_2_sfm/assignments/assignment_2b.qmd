...
Click the **Import Reference** icon ![Import icon](images/import_icon.webp){width=25} in the Reference pane toolbar and select the camera positions file `2016_09_22_sample.txt`.
...
::: {.callout-info}
[Agisoft Metashape Post: What Camera Calibration Results Mean in Agisoft Metashape: A Complete Guide](https://www.agisoftmetashape.com/what-camera-calibration-results-mean-in-agisoft-metashape-a-complete-guide/)
:::
