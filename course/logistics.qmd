...
- [GRASS GIS 8.4](http://grass.osgeo.org/) (you can use [these instructions to install it](http://ncsu-geoforall-lab.github.io/geospatial-modeling-course/logistics.html#software))
...
- [OpenDroneMap](http://opendronemap.org/) and 

### Other resources

- ([MicMac](http://logiciels.ign.fr/?-Micmac,3-) documentation can be found [here](http://logiciels.ign.fr/IMG/pdf/docmicmac-2.pdf), not used in this course)
